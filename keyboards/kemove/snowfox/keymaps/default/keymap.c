...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_FN_LAYER] = KEYMAP( /* Base */
    ...
    KC_TRNS, SNOWFOX_BLE_KB1, SNOWFOX_BLE_KB2, SNOWFOX_BLE_KB3, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL, KC_END, KC_PGDN, KC_DELETE, KC_PGUP,
...
void dip_switch_update_user(uint8_t index, bool active) {
  switch (index) {
    case 0:
      if (active == snowfox_traits.dip_winmac_win) {
